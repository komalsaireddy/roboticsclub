      ...
      >
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between">
          ...
          <div className="hidden items-center gap-6 lg:flex xl:gap-8">
            ...
            {navigation.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="font-mono text-[11px] font-medium uppercase tracking-[0.14em] text-white/50 transition-colors duration-300 hover:text-cyan-300"
              >
                {item.label}
              </a>
            ))}
          ...
          <div className="hidden lg:block">
            ...
            <a
              href="#contact"
              className="group inline-flex h-11 items-center gap-3 rounded-full border border-white/[0.12] bg-white/[0.025] px-5 font-mono text-[11px] font-medium uppercase tracking-[0.16em] text-white/65 backdrop-blur-sm transition-all duration-300 hover:border-cyan-300/30 hover:bg-white/[0.05] hover:text-white"
            >
              <span>
                Join Club
              </span>
        ...
        <div className="flex min-h-screen flex-col px-7 pb-10 pt-32">
          ...
          <div className="mt-auto">
            ...
            <a
              href="#contact"
              onClick={closeMenu}
              className="inline-flex h-12 items-center gap-3 rounded-full bg-white px-7 font-mono text-[11px] font-semibold uppercase tracking-[0.18em] text-black transition-transform duration-300 hover:scale-[1.02]"
            >
              Join Club
